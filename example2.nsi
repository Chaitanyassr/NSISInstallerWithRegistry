...
InstallDirRegKey HKCU "Software\NSIS_Example2" "Install_Dir"
...
Section "Example2 (required)"
  ...
  WriteRegStr HKCR "super" "" "URL:super Protocol"
  WriteRegStr HKCR "super" "URL Protocol" ""
  WriteRegStr HKCR "super\DefaultIcon" "" "$INSTDIR\whiteboard.exe"
  WriteRegStr HKCR "super\Shell" "" ""
  WriteRegStr HKCR "super\Shell\open\command" "" "$INSTDIR\whiteboard.exe"
